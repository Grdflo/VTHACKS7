  ...
  $.ajax({
    ...
    statusCode : {
      200 : function() {
        ...
        image1.src = 'link/to/folder/before/folder' + toString(location) + 'image1';
        image2.src = 'link/to/folder/before/folder' + toString(location) + 'image2';
        image3.src = 'link/to/folder/before/folder' + toString(location) + 'image3';
